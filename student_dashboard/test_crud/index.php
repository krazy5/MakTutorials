                ...
                <div class="card">
                    <div class="card-header">
						<h4>Student Test Records
							<a href="add_test.php?Student_id=<?= urlencode($selected_student_id); ?>" class="btn btn-light float-end ms-2" target="_blank">Add Test Record</a>
                                ...
                                <tbody>
                                    ...
                                    $mobile=$_SESSION['student'];
                                        ...
                                        $query = "SELECT sr.first_name, sr.last_name, st.test_id, st.subject, st.marks_obtained, st.total_marks, st.percentage, st.test_date, st.grade
                                                  ...
                                                  JOIN student_record sr ON st.student_id = sr.student_id and
                                                   sr.mobile_no='$mobile'";
