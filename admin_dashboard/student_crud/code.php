    ...
    if (isset($_FILES['photo'])) {
        ...
        if ($_FILES['photo']['error'] === UPLOAD_ERR_OK) {
            if (move_uploaded_file($photo_tmp, $photo_folder)) {
                ...
                $query = "INSERT INTO student_record (first_name, last_name, parent_name, dob, mobile_no, gender, address, start_date, school_college, std, photo, roll_no, batch_name, class_subject, reciept_no,password) 
                          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?)";
                ...
                // Bind parameters to the prepared statement
                mysqli_stmt_bind_param($stmt, "sssssssssssdssss", $first_name, $last_name, $parent_name, $dob, $mobile_no, $gender, $address, $start_date, $school_college, $std, $photo_folder, $roll_no, $batch_name, $class_subject, $recipet_no,$dob);
